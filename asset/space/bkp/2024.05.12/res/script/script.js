...
function loadLibs() {
  ...
  // Load Font Awesome from CDN or local source
  function loadFontAwesome() {
    // Function to load Font Awesome from local source
    function loadLocalFontAwesome() {
      var faLocalLink = document.createElement('link');
      faLocalLink.rel = 'stylesheet';
      faLocalLink.href = 'res/lib/fontawesome/css/all.min.css';
      document.head.appendChild(faLocalLink);
      console.log('Font Awesome loaded from local source.');
    }

    // Function to check if Font Awesome from CDN is loaded
    function isFontAwesomeLoaded() {
      return window.fontawesome !== undefined;
    }

    // Check if Font Awesome from CDN is loaded, if not, load local version
