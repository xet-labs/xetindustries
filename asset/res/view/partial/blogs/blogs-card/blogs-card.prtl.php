...
<div class="post">
    ...
    <!-- post image -->
    <a href="<?php echo htmlspecialchars($Blog['path']); ?>" class="post-img-wrap">
        <div class="post-img">
            ...
            <div class="post-meta-wrap">
                <div class="post-meta">
                    ...
                    <div class="meta-author-img">
                        <a href="">
                            <img src="<?php echo $Blog['profile_img']; ?>" alt="<?php echo htmlspecialchars($Blog['name'] . " ". $Blog['name_l']); ?>" loading="lazy" fetchpriority="low">
                        </a>
                    </div>
