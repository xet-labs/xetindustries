...
if (Auth::check()) { ?>
    ...
    <!-- logOut button -->
    <form method="post" action="<?php echo route('user.logout'); ?>">
        <?php include(Loc::file('PRTL','csrf')); ?>
        <?php include(Loc::file('PRTL','currentUrl')); ?>
        <button type="submit" name="submit_logout" aria-label="Log Out" class="icon">
    ...
    <div class="signuplogin-wrap">
        <div class="signuplogin">
            ...
            <div class="login-wrap">
                ...
                <form class="signuplogin-form" method="post" action="<?php echo route('user.login'); ?>">
                    <?php include(Loc::file('PRTL','csrf')); ?>
                    <?php include(Loc::file('PRTL','currentUrl')); ?>
            ...
            <div class="signup-wrap">
                ...
                <form class="signuplogin-form" method="post" action="<?php echo route('user.signup'); ?>">
                    <?php include(Loc::file('PRTL','csrf')); ?>
                    <?php include(Loc::file('PRTL','currentUrl')); ?>
