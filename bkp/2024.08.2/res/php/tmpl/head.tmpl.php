...
<head>
	...
	<?php if (!isset($_SESSION["userId"])){ ?><link rel="stylesheet" type="text/css" href="res/css/login.css"><?php }; ?>
	<?php if (file_exists('style.css')){ ?><link rel="stylesheet" type="text/css" href="style.css"><?php }; ?>
	

	<?php $pageTag = isset($pageTag) && is_array($pageTag) ? $pageTag : []; if (in_array('blog', $pageTag)){ ?><link rel="stylesheet" type="text/css" href="res/css/blog.css"><?php }; ?>
