...
<h2>
    ...
    <div class="content-logo-wrap">
        ...
        <img src="<?= asset("{$imgSrc}/myst-favicon-64.png") ?>" alt="">
        </div>
    </div>
    </a>
</h2>
...
<ol class="">
    ...
    <!-- <div class="li-img-wrap">
        <div class="li-img">
        <img src="<?= asset("{$imgSrc}/myst-signup.webp") ?>" alt="myst-signup">
        </div>
    </div> -->
    </li>
    ...
    <!-- <div class="li-img-wrap">
        <div class="li-img">
        <img src="<?= asset("{$imgSrc}/myst-onboard.webp") ?>" alt="myst-onboard">
        </div>
    </div> -->
    </li>
    ...
    <!-- <div class="li-img-wrap">
        <div class="li-img">
        <img src="<?= asset("{$imgSrc}/myst-node-clickboard.webp") ?>" alt="myst-node-clickboard">
        </div>
    </div> -->
    </li>
    ...
    <!-- <div class="li-img-wrap">
        <div class="li-img">
        <img src="<?= asset("{$imgSrc}/myst-clickboard.webp") ?>" alt="myst-clickboard">
        </div>
    </div> -->
    </li>
    <li>
...
<h2>
    ...
    <div class="content-logo-wrap">
        <div class="content-logo">
        <img src="<?= asset("{$imgSrc}/earnapp-favicon-64.png") ?>" alt="">
        </div>
    </div>
    </a>
</h2>
...
<h2>
    ...
    <div class="content-logo-wrap">
        <div class="content-logo">
        <img src="<?= asset("{$imgSrc}/packetstream-favicon-64.png") ?>" alt="">
        </div>
    </div>
    </a>
</h2>
...
<h2>
    ...
    <div class="content-logo-wrap">
        <div class="content-logo">
        <img src="<?= asset("{$imgSrc}/honeygain-favicon-64.png") ?>" alt="">
        </div>
    </div>
    </a>
</h2>
...
<h2>
    ...
    <div class="content-logo-wrap">
        <div class="content-logo">
        <img src="<?= asset("{$imgSrc}/repocket-favicon-64.png") ?>" alt="">
        </div>
    </div>
    </a>
</h2>
...
<h2>
    ...
    <div class="content-logo-wrap">
        <div class="content-logo">
        <img src="<?= asset("{$imgSrc}/pawnsapp-favicon-64.png") ?>" alt="">
        </div>
    </div>
    </a>
</h2>
...
<h2>
    ...
    <div class="content-logo-wrap">
        <div class="content-logo">
        <img src="<?= asset("{$imgSrc}/traffmonetizer-favicon-64.png") ?>" alt="">
        </div>
    </div>
    </a>
</h2>
