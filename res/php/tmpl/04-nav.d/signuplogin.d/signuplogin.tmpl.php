        ...
        <div class="signuplogin-wrap">
            <div class="signuplogin">
                <span class="signuplogin-brand">
                    <a href="/#" rel="noopener noreferrer"><?php echo file_get_contents($BRAND['brand']); ?></a>
                </span>
                ...
                <div class="login-wrap">
                    ...
                    <form class="signuplogin-form" method="post" action="<?php echo htmlspecialchars($INC_URL['formctl']); ?>">
                        ...
                        <div class="field-wrap">
                            ...
                            <input type="text" name="login-email" id="login-email" autocomplete="email"  aria-label="Email Address" required placeholder="email or username">
                        </div>
                        
                        <div class="field-wrap">
                            <div class="label-wrap">
                                <p class="label">Password</p><a class="" href="">Forgot password?</a>
                            </div>
