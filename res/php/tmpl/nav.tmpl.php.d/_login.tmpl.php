...
if (isset($_SESSION["userId"])) { ?>
    ...
    <form class="" action="<?php echo htmlspecialchars($INC_URL['formctl']); ?>" method="post">
        ...
        <button type="submit" name="submit-logout" class="icon button" aria-label="Log Out">
            <i class="">
...
<?php }else{ ?>
    ...
    <!-- logIn button -->
    <input type="checkbox" class="underlayCheckbox" id="LoginSwitch">
    <label for="LoginSwitch" class="underlay"></label>
    <label for="LoginSwitch" class="button">
        <i class="icon">
    ...
    <div class="login" id="login">
        <form action="<?php echo htmlspecialchars($INC_URL['formctl']); ?>" class="login__form" method="post">
            <input type="hidden" name="currentUrl" value="<?php echo htmlspecialchars($currentUrl); ?>">
